...
mxLoadStylesheets&&mxClient.link("stylesheet",mxClient.basePath+"/static/css/common.css");"undefined"!=typeof mxLanguages&&(mxClient.languages=mxLanguages);
...
this.setStylesheet(d!=null?d:this.createStylesheet());this.view=this.createGraphView();this.graphModelChangeListener=mxUtils.bind(this,function(a,b){this.graphModelChanged(b.getProperty("edit").changes)});this.model.addListener(mxEvent.CHANGE,this.graphModelChangeListener);this.createHandlers();a!=null&&this.init(a);this.view.revalidate()}mxLoadResources&&mxResources.add(mxClient.basePath+"/static/resources/graph");mxGraph.prototype=new mxEventSource;mxGraph.prototype.constructor=mxGraph;
